...
public class ConsolaEmpleado {
    ...
    public void CrearReserva() {
        ...
        ArrayList<HabitacionBase> HabitacionesBs = padreInterfaz.buscarHabitaciones(cocinaB, balconB, vistaB,
                fechainicial, fechafinal, tipo);
        String estadoReserva = "reservado";
        double precio = padreInterfaz.CrearReserva(documento, estadoReserva, personasEsperadas, fechainicial,
    ...
    public void AñadirServicio() {
        ...
        if (servicio.equals("Restaurante")) {
            ...
            while (parar == false) {
                ...
                String confirmar = Input.input(
                        "Escriba cancelar para no guardar este producto. Escriba repetir para repetir el proceso completo.Escriba continuar para no hacer ninguna de los opciones anteriores.");
    ...
    public void HacerCheckIn() {
        ...
        while (flag == true) {
            ...
            String continuar = Input.input(
                    "Si desea hacer el check in de otra persona escriba continuar. Si desea salir escriba salir");
