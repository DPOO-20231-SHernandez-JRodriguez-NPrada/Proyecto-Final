...
public class ConsolaAdmin extends ConsolaEmpleado {
    ...
    public void CambiarTarifa() {
        try {
            ...
            while (continuar) {
                System.out.print(
                        "Ingrese un dia de la semana como MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY o SUNDAY\n O ingrese \"salir\" si no desea agregar mas dias : ");
            ...
            // En este punto ConsolaAdmin deberia llamar a la funcion cambiarTarifa(String
            // tipo, int anio, Double precio, String finicio, String ffinal,
            // ArrayList<String> dias) de EnrutadorPrincipal
