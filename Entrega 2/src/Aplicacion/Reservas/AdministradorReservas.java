...
public class AdministradorReservas {
    ...
    public double CrearReserva(String documento, String estadoReserva, int personasEsperadas, String fechainicial,
            String fechafinal, ArrayList<HabitacionBase> HabitacionesBs, Huesped huesped) {
        ...
        Reserva datosReserva = new Reserva(documento, estadoReserva, personasEsperadas, fechainicial, fechafinal,
                HabitacionesRs);
    ...
    public void AñadirServicio(String documento, ServicioBase Nombreservicio, String descripcion, String fecha,
