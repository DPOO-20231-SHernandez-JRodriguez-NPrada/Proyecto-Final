...
public class VerYReservarCuartosJPanel extends JPanel implements ActionListener{
    ...
    private JPanel jpEspecificaciones;
    private JLabel lblIdHabitacionBase;
    private JTextArea txtAExplicacion;
    private JTextField txtfIdHabitacionBase;
    ...
    public VerYReservarCuartosJPanel(InterfazprincipalHuespedJFrame interfazPrincipalJFrame) {
        ...
        jpFiltros.setPreferredSize(new Dimension(500, 220));
        ...
        Border bdEspecificaciones = BorderFactory.createTitledBorder("Especificaciones");
        jpEspecificaciones = new JPanel(new FlowLayout(1, 2, 10));
        jpEspecificaciones.setBorder(bdEspecificaciones);
        jpEspecificaciones.setLayout(new FlowLayout(1,0,3));
        jpEspecificaciones.setAlignmentY(TOP_ALIGNMENT);
        jpEspecificaciones.setPreferredSize(new Dimension(200, 220));
        jpEspecificaciones.setMaximumSize(getPreferredSize());

        txtAExplicacion = new JTextArea("Buscar detalles sobre el hotel y la habitación especificada");
        txtAExplicacion.setLineWrap(true);
        txtAExplicacion.setWrapStyleWord(true);
        txtAExplicacion.setFont(new Font("Arial", Font.BOLD, 14));
        txtAExplicacion.setPreferredSize(new Dimension(180, 70));
        txtAExplicacion.setMaximumSize(getPreferredSize());

        lblIdHabitacionBase = new JLabel("Id:");
        lblIdHabitacionBase.setFont(new Font("Arial", Font.BOLD, 18));
        lblIdHabitacionBase.setPreferredSize(new Dimension(40, 50));
        lblIdHabitacionBase.setMaximumSize(getPreferredSize());

        txtfIdHabitacionBase = new JTextField();
        txtfIdHabitacionBase.setFont(new Font("Arial", Font.PLAIN, 18));
        txtfIdHabitacionBase.setPreferredSize(new Dimension(150, 50));
        txtfIdHabitacionBase.setMaximumSize(getPreferredSize());

        btnConsultar = new JButton("Consultar");
        btnConsultar.addActionListener(this);
        btnConsultar.setActionCommand("CONSULTAR");
        btnConsultar.setPreferredSize(new Dimension(100, 50));
        btnConsultar.setMaximumSize(getPreferredSize());

        jpEspecificaciones.add(txtAExplicacion);
        jpEspecificaciones.add(lblIdHabitacionBase);
        jpEspecificaciones.add(txtfIdHabitacionBase);
        jpEspecificaciones.add(btnConsultar);

        jpAuxNorte.add(jpFiltros);
        jpAuxNorte.add(jpEspecificaciones);
        ...
        add(jpAuxNorte, BorderLayout.NORTH);
    ...
    private void consultarHabitacion() {
        ...
        if(txtfIdHabitacionBase.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Debe ingresar un ID de habitacion", "Error", JOptionPane.ERROR_MESSAGE);
        }
        else{
            CaracteristicasHotel caracteristicasHotel = ventanaPadre.darCaracteristicasHotel();
            HabitacionBase habitacion = ventanaPadre.BuscarHabitacionBase(txtfIdHabitacionBase.getText());

            if(habitacion == null){
                JOptionPane.showMessageDialog(this, "No se encontró la habitacion", "Error", JOptionPane.ERROR_MESSAGE);
            }
            else{
                new VerEspecificacionesHotelHabitacionJFrame(caracteristicasHotel, habitacion);
